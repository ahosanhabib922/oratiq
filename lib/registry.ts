...
export const GROUPS: RegistryGroup[] = [
  {
    ...
    items: [
      ...
      { slug: "multi-select", name: "Multi Select", description: "Select many options as removable tags.", status: "planned", dependencies: ["cmdk"] },
      { slug: "rating", name: "Rating", description: "Star rating, display and input.", status: "planned" },
      { slug: "tag-input", name: "Tag Input", description: "Dismissible tags with free entry.", status: "planned" },
      { slug: "social-buttons", name: "Social Buttons", description: "OAuth sign-in buttons.", status: "planned" },
      { slug: "color-picker", name: "Color Picker", description: "Pick a colour with swatches and input.", status: "planned" },
      { slug: "file-uploader", name: "File Uploader", description: "Drag-and-drop upload zone.", status: "planned" },
      { slug: "rich-text-editor", name: "Rich Text Editor", description: "Formatted text entry with a toolbar.", status: "planned" },
    ],
  },
  {
    name: "Display",
    items: [
      ...
      { slug: "featured-icon", name: "Featured Icon", description: "An icon on a styled tile.", status: "planned" },
      { slug: "metric", name: "Metric", description: "Stat card with delta and trend.", status: "planned" },
      { slug: "code-snippet", name: "Code Snippet", description: "Code with a copy button.", status: "planned" },
      { slug: "qr-code", name: "QR Code", description: "Generate a themed QR code.", status: "planned" },
      { slug: "video-player", name: "Video Player", description: "Media player with themed controls.", status: "planned" },
    ],
  },
  {
    name: "Overlay",
  ...
  },
  {
    name: "App patterns",
    items: [
      { slug: "page-header", name: "Page Header", description: "Title, meta, and actions atop a page.", status: "planned" },
      { slug: "section-header", name: "Section Header", description: "Heading row with supporting actions.", status: "planned" },
      { slug: "filter-bar", name: "Filter Bar", description: "Search, filters, and view controls in one row.", status: "planned" },
      { slug: "activity-feed", name: "Activity Feed", description: "Timeline of events with actors and times.", status: "planned" },
      { slug: "progress-steps", name: "Progress Steps", description: "Multi-step wizard indicator.", status: "planned" },
      { slug: "tree-view", name: "Tree View", description: "Nested, keyboard-navigable hierarchy.", status: "planned" },
      { slug: "notifications", name: "Notifications", description: "Inbox-style notification list.", status: "planned" },
    ],
  },
  {
    name: "Messaging",
